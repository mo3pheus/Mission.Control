        ...
        while (choice != 14) {
            ...
            switch (choice) {
                ...
                case 12: {
                    ...
                    System.out.println(" Please enter dates in the following format :: yyyy-MM-dd~hh:mm:ss");
                    System.out.println("Please enter startDate::");
                    String startDate = dateScanner.nextLine();
                    System.out.println("Please enter endDate::");
                    String endDate = dateScanner.nextLine();
                    byte[] msg     = CommandBuilder.buildLogRequestCommand(startDate, endDate);
                    transmitter.transmitMessage(msg);
                }
                break;
                case 13: {
